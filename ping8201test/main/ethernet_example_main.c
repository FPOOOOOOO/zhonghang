...
static void example_set_static_ip(esp_netif_t *netif)
{
    ...
    //----------------------------------//
    if (esp_netif_set_ip_info(netif, &eth) != ESP_OK)
    {
                              ...
                              int32_t event_id, void *event_data)
{
    ...
    case ETHERNET_EVENT_CONNECTED:
        // added from csdn, Esp has not equipped default, wired.
        // tcpip_adapter_dhcpc_stop(TCPIP_ADAPTER_IF_ETH); too oldf should be netif
        // tcpip_adapter_ip_info_t eth;
        // tcpip_adapter_set_ip_info(TCPIP_ADAPTER_IF_ETH,(const char*) &eth);
        // added from csdn, Esp has not equipped default, wired.
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "We are between event_handle and got_ip");
