...
#include "nvs_flash.h"
#include "esp_event_loop.h"//added without esp_event.h
#include "tcpip_adapter.h"//added
#include "esp_wifi.h"
#include "esp_log.h"
#include "esp_system.h"
#include "esp_now.h"
#include "esp32/rom/ets_sys.h"//added
#include "esp32/rom/crc.h"//added
#include "espnowv1.h"//added
#include "esp_timer.h"//added
#include "esp_private/wifi.h"//added
...
static uint8_t example_broadcast_mac[ESP_NOW_ETH_ALEN] = {0xC4, 0xDD, 0x57, 0xCA, 0x99, 0x00};
//uint8_t espNowNode[ESP_NOW_ETH_ALEN] = {0x30, 0xAE, 0xA4, 0x21, 0x28, 0x44}; 
uint8_t espNowNode[ESP_NOW_ETH_ALEN] = {0xC4, 0xDD, 0x57, 0xCA, 0xBC, 0x30}; 
